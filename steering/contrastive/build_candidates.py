"""
Разворачивание сетки contrastive steering-кандидатов в замороженный каталог.

Вход:  steering/contrastive/configs/contrastive_gender_{2b|4b}_v1.yaml
Выход: steering/contrastive/candidates/contrastive_gender_{scale}_candidates_v1.json
       steering/contrastive/candidates/contrastive_gender_{scale}_candidates_v1.md
...
def main(argv: list[str] | None = None) -> int:
    ...
    prefix = f"contrastive_gender_{scale}_candidates"
    ...
    if args.verify:
        ...
        if bad:
            ...
            return 1
        print("OK — contrastive candidates совпадают с пересборкой")
        return 0
    ...
    print(
        f"contrastive {scale} {ver}: {doc['n_candidates']} candidates "
