...
ROOT = Path(__file__).resolve().parents[1]  # experiments/qwen35-4b-base
# occupational-gender-bias/ and repo/ are siblings under the workspace.
SRC = ROOT.parents[2] / "repo"
RUN_SRC = "TBD_after_qwen35_4b_inference"
